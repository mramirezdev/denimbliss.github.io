...
function eightstore_lite_scripts() {
	...
	wp_enqueue_style( 'eightstore-keyboard', get_template_directory_uri() . '/css/keyboard.css' );
	...
	if(is_rtl()){
		wp_enqueue_style( 'eightstore-rtl', get_template_directory_uri() . '/css/rtl.css');
	}
