...
function eightstore_lite_custom_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting('eightstore_inner_feat_img_post',array(
		'default' =>  '1',
		'sanitize_callback'     =>  'eightstore_lite_checkbox_sanitize'
	));

	$wp_customize->add_control(new Eightstore_lite_WP_Customize_Switch_Control($wp_customize,'eightstore_inner_feat_img_post',array(
		'section'       =>      'single_post_settings',
		'label'         =>      __('Enable Featured Image', 'eightstore-lite'),
		'type'          =>      'switch',
		'output'        =>      array('Yes', 'No')
	)));
