			...
			<section id="section-below-slider" class="clear">
				<div class="store-wrapper">
					...
					$loop = new WP_Query(array(
						'category_name' => $eightstore_lite_category_promo_setting_category,
						'posts_per_page' => 4,
						'order' => 'ASC' 
						));
					if($loop->have_posts()) { 
	...
	<section id="blog-testimonial-section" class="clear<?php if(get_theme_mod('eightstore_blog_section')=='1'){echo " blog-only";} if(get_theme_mod('eightstore_testimonial_section')=='1'){echo " testimonial-only";}?>">
		<div class="store-wrapper">
			...
			if(get_theme_mod('eightstore_blog_section')=='1'){
				...
				?>
				<?php 
				if( !empty($wl_blog_cat) ):?>

				<section class="blogs" data-wow-delay="0.8s">
					<div class="ed-container">
						<h2 class="home-title wow flipInX"><b><?php echo esc_html(get_theme_mod('eightstore_blog_title')); ?></b></h2><div class="title-border"></div>
						<div class="blog-wrap wow fadeInRight clearfix">
							<?php
							$blog_args      =   array('category_name'=>$wl_blog_cat, 'post_status'=>'publish', 'posts_per_page'=>-1);
			...
			if(get_theme_mod('eightstore_testimonial_section')=='1'){
				...
				?>
				<?php 
				if( !empty( $wl_testimonial_cat) ):?>

				<section class="testimonials" data-wow-delay="0.8s">
					<div class="ed-container">
						<h2 class="home-title wow flipInX"><b><?php echo esc_html(get_theme_mod('eightstore_testimonial_title')); ?></b></h2><div class="title-border"></div>
						<div class="testimonial-wrap wow fadeInRight clearfix">
							<?php
							$testimonial_args      =   array('category_name'=>$wl_testimonial_cat, 'post_status'=>'publish', 'posts_per_page'=>-1);
