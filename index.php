...
<div class="store-wrapper">
	<?php
	$archive_page_layout = get_theme_mod('archive_page_layout','sidebar-right');
	if(is_home()){
		$archive= 'archive';
	}
	?>
	<main id="main" class="site-main <?php echo esc_attr($archive_page_layout).' '.esc_attr($archive); ?>" role="main">
